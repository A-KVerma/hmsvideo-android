...
The sample application should run without any issues after you have the latest SDK. You don't need to add any other additional steps.

The sample app uses build tool version 30.

![SDK version](img/sdkmanager.png?raw=true "SDK Version")

Once you have both SDK, you can simply run the application. 
...
Now follow the same steps for brytecam-lib-1.0.3 lib as well
